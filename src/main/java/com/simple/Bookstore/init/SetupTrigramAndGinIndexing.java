...
public class SetupTrigramAndGinIndexing {
    ...
    public void run() {
        ...
        if (!activeProfile.equals("dev")) {
            System.out.println("[SetupTrigramAndGinIndexing] Skipped setup (profile: " + activeProfile + ")");
            return;
        }
        ...
        System.out.println("[SetupTrigramAndGinIndexing] pg_trgm extension and GIN indexes applied.");
    }
    ...
    public void cleanup() {
        ...
        System.out.println("[SetupTrigramAndGinIndexing] GIN indexes dropped.");
    }
}
